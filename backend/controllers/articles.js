...
exports.deleteArticle = (req, res, next) => {
  ...
  console.log(2);
      ...
      console.log(3);
      console.log(req.required.userId);
      console.log(req.article.author._id);


      if (req.required.userId.toString() === req.article.author._id.toString()) {
  console.log(4);
